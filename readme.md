...
- 如果您基于本代码重新修改发布您自己的作品时，也强烈建议不要将上述信息内置于您的代码中。
...
- 休眠自动唤醒
  ...
  GPIO16（D0）通过470欧左右的电阻连接到RST脚，使用电阻的目的是保护IO端口，以免在意外的情况下烧毁IO管脚。换句话说，如果你对自己的手法有信心，也可以省掉这个电阻，**但仍需用跳线直接短路D0与RST脚**。（如果你没接这条线，板子休眠后会无法自动唤醒）
