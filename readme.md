...
- 休眠自动唤醒
  ...
  GPIO16（D0）与RST脚使用短路线或通过470欧电阻短接。注意，因为模块电路板上RST脚原有外围电路的影响：A、如果直接短接此二引脚，将使模块上的复位按键功能失效；B、这个电阻只能使用470欧，阻值过小会使复位按键功能失效，阻值过大或漏接，系统休眠后将会无法自动唤醒！！（2022.1.18：我刚刚经历了此电阻由470变值为680欧左右，造成系统经常不能唤醒）
